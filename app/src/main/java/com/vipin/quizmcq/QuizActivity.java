...
import com.vipin.quizmcq.services.RequestQuestionService;
import com.vipin.quizmcq.utils.Constants;
import com.vipin.quizmcq.utils.NetworkHelper;
import com.vipin.quizmcq.viewmodel.QuizViewModel;
...
public class QuizActivity extends AppCompatActivity {
    ...
    private void setUpToolbar() {
        ...
        title.setText("General Knowledge Quiz");
    }
    ...
    private BroadcastReceiver questionResponseReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(QuizActivity.this,
                    "Received : " + questions.size() + " Questions from API.",
